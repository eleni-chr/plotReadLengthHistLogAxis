function plotReadLengthHistLogAxis
...
%Save plot.
savefig(fig,'ReadLength_Hist_LogAxis'); %save figure as a FIG file in the working directory.
fig.Renderer='painters'; %force MATLAB to render the image as a vector.
saveas(fig,'ReadLength_Hist_LogAxis.svg'); %save figure as an SVG file.
close
clear
end